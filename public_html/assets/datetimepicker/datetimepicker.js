        ...
        (L.fn.xdsoftScroller = function (D, y) {
            return this.each(function () {
                var o,
                    ...
                    p = function () {};
                "hide" !== y
                    ? (L(this).hasClass("nue_scroller_box") ||
                          ((o = l.children().eq(0)),
                          (f = Math.abs(parseInt(o.css("marginTop"), 10))),
                          (i = l[0].clientHeight),
                          (s = o[0].offsetHeight),
                          (d = L('<div class="nue_scrollbar"></div>')),
                          (u = L('<div class="nue_scroller"></div>')),
                          d.append(u),
                          l.addClass("nue_scroller_box").append(d),
                          (p = function (e) {
                              var t = a(e).y - r + g;
                              t < 0 && (t = 0), t + u[0].offsetHeight > h && (t = h - u[0].offsetHeight), l.trigger("scroll_element.nue_scroller", [c ? t / c : 0]);
                          }),
                          u
                              .on("touchstart.nue_scroller mousedown.nue_scroller", function (e) {
                                  i || l.trigger("resize_scroll.nue_scroller", [y]),
                                      (r = a(e).y),
                                      (g = parseInt(u.css("marginTop"), 10)),
                                      (h = d[0].offsetHeight),
                                      "mousedown" === e.type || "touchstart" === e.type
                                          ? (D.ownerDocument && L(D.ownerDocument.body).addClass("nue_noselect"),
                                            L([D.ownerDocument.body, D.contentWindow]).on("touchend mouseup.nue_scroller", function e() {
                                                L([D.ownerDocument.body, D.contentWindow]).off("touchend mouseup.nue_scroller", e).off("mousemove.nue_scroller", p).removeClass("nue_noselect");
                                            }),
                                            L(D.ownerDocument.body).on("mousemove.nue_scroller", p))
                          ...
                          l
                              .on("scroll_element.nue_scroller", function (e, t) {
                                  i || l.trigger("resize_scroll.nue_scroller", [t, !0]),
                                      (t = 1 < t ? 1 : t < 0 || isNaN(t) ? 0 : t),
                                      (f = parseFloat(Math.abs((o[0].offsetHeight - i) * t).toFixed(4))),
                                      u.css("marginTop", c * t),
                                      o.css("marginTop", -f);
                              })
                              .on("resize_scroll.nue_scroller", function (e, t, a) {
                                  var n, r;
                                  (i = l[0].clientHeight),
                                      (s = o[0].offsetHeight),
                                      (r = (n = i / s) * d[0].offsetHeight),
                                      1 < n ? u.hide() : (u.show(), u.css("height", parseInt(10 < r ? r : 10, 10)), (c = d[0].offsetHeight - u[0].offsetHeight), !0 !== a && l.trigger("scroll_element.nue_scroller", [t || f / (s - i)]));
                              }),
                          l.on("mousewheel", function (e) {
                              var t,
                                  ...
                                  n =
                                      ...
                                      a),
                                  r = Math.max(0, f - n);
                              return l.trigger("scroll_element.nue_scroller", [r / (s - i)]), e.stopPropagation(), !1;
                          }),
                          ...
                          l.on("touchmove", function (e) {
                              if (n) {
                                  e.preventDefault();
                                  var t = a(e);
                                  l.trigger("scroll_element.nue_scroller", [(m - (t.y - n.y)) / (s - i)]);
                              }
                          }),
                          l.on("touchend touchcancel", function () {
                              (n = !1), (m = 0);
                          })),
                      l.trigger("resize_scroll.nue_scroller", [y]))
                    : l.find(".nue_scrollbar").hide();
            });
        }),
            ...
            return (
                (n = function (O) {
                    var t,
                        ...
                        W,
                        h,
                        _ = L('<div class="nue_datetimepicker nue_noselect"></div>'),
                        e = L('<div class="nue_copyright"><a target="_blank" href="http://xdsoft.net/jqplugins/datetimepicker/">xdsoft.net</a></div>'),
                        g = L('<div class="nue_datepicker active"></div>'),
                        F = L(
                            '<div class="nue_monthpicker"><button type="button" class="nue_prev"></button><button type="button" class="nue_today_button"></button><div class="nue_label nue_month"><span></span><i></i></div><div class="nue_label nue_year"><span></span><i></i></div><button type="button" class="nue_next"></button></div>'
                        ),
                        C = L('<div class="nue_calendar"></div>'),
                        o = L('<div class="nue_timepicker active"><button type="button" class="nue_prev"></button><div class="nue_time_box"></div><button type="button" class="nue_next"></button></div>'),
                        u = o.find(".nue_time_box").eq(0),
                        P = L('<div class="nue_time_variant"></div>'),
                        i = L('<button type="button" class="nue_save_selected blue-gradient-button">Save Selected</button>'),
                        Y = L('<div class="nue_select nue_monthselect"><div></div></div>'),
                        A = L('<div class="nue_select nue_yearselect"><div></div></div>'),
                        s = !1,
                        d = 0;
                    I.id && _.attr("id", I.id),
                        I.style && _.attr("style", I.style),
                        I.weeks && _.addClass("nue_showweeks"),
                        I.rtl && _.addClass("nue_rtl"),
                        _.addClass("nue_" + I.theme),
                        _.addClass(I.className),
                        F.find(".nue_month span").after(Y),
                        F.find(".nue_year span").after(A),
                        F.find(".nue_month,.nue_year").on("touchstart mousedown.xdsoft", function (e) {
                            var t,
                                a,
                                n = L(this).find(".nue_select").eq(0),
                                r = 0,
                                o = 0,
                                i = n.is(":visible");
                            for (
                                F.find(".nue_select").hide(), W.currentTime && (r = W.currentTime[L(this).hasClass("nue_month") ? "getMonth" : "getFullYear"]()), n[i ? "hide" : "show"](), t = n.find("div.nue_option"), a = 0;
                    ...
                    F.find(".nue_select")
                        ...
                        .on("touchmove", ".nue_option", l)
                        .on("touchend mousedown.xdsoft", ".nue_option", function () {
                            if (!this.touchMoved) {
                                (void 0 !== W.currentTime && null !== W.currentTime) || (W.currentTime = W.now());
                                var e = W.currentTime.getFullYear();
                                W && W.currentTime && W.currentTime[L(this).parent().parent().hasClass("nue_monthselect") ? "setMonth" : "setFullYear"](L(this).data("value")),
                        ...
                        (_.setOptions = function (e) {
                            ...
                            (I = L.extend(!0, {}, I, e)),
                                ...
                                I.inline && ((s = !0), _.addClass("nue_inline"), O.after(_).hide()),
                                I.inverseButton && ((I.next = "nue_prev"), (I.prev = "nue_next")),
                                ...
                                F.find(".nue_today_button").css("visibility", I.todayButton ? "visible" : "hidden"),
                                ...
                                I.validateOnBlur &&
                                    O.off("blur.xdsoft").on("blur.xdsoft", function () {
                                        if (I.allowBlank && (!L.trim(L(this).val()).length || ("string" == typeof I.mask && L.trim(L(this).val()) === I.mask.replace(/[0-9]/g, "_")))) L(this).val(null), _.data("nue_datetime").empty();
                                        else {
                                            ...
                                            _.data("nue_datetime").setCurrentTime(L(this).val());
                                        }
                        ...
                        F.find(".nue_prev,.nue_next").on("touchend mousedown.xdsoft", function () {
                            var a = L(this),
                                n = 0,
                                r = !1;
                            !(function e(t) {
                        ...
                        o.find(".nue_prev,.nue_next").on("touchend mousedown.xdsoft", function () {
                            var o = L(this),
                                i = 0,
                                s = !1,
                                d = 110;
                            !(function e(t) {
                                ...
                                r < I.timeHeightInTimePicker ? (r = I.timeHeightInTimePicker) : o.hasClass(I.next) && n - a < r && P.css("marginTop", "-" + n + "px"),
                                    ...
                                    u.trigger("scroll_element.nue_scroller", [Math.abs(parseInt(P[0].style.marginTop, 10) / (n - a))]),
                                    (d = 10 < d ? 10 : d - 10),
                        ...
                        _.on("xchange.xdsoft", function (e) {
                            clearTimeout(t),
                                (t = setTimeout(function () {
                                    ...
                                    for (
                                        var e, t, a, n, r, o, i, s, d, u, l = "", f = new Date(W.currentTime.getFullYear(), W.currentTime.getMonth(), 1, 12, 0, 0), c = 0, m = W.now(), h = !1, g = !1, p = !1, D = !1, y = [], v = !0, k = "";
                                    ...
                                    for (
                                        ...
                                        (y = []),
                                            ...
                                            I.allowDateRe && "[object RegExp]" === Object.prototype.toString.call(I.allowDateRe) && (I.allowDateRe.test(E.formatDate(f, I.formatDate)) || y.push("nue_disabled")),
                                            I.allowDates && 0 < I.allowDates.length && -1 === I.allowDates.indexOf(E.formatDate(f, I.formatDate)) && y.push("nue_disabled");
                                        var b = 31 * (12 * f.getFullYear() + f.getMonth()) + f.getDate();
                                        ((!1 !== h && h < f) || (!1 !== p && f < p) || (!1 !== g && f < g) || (!1 !== D && u < b) || (i && !1 === i[0])) && y.push("nue_disabled"),
                                            -1 !== I.disabledDates.indexOf(E.formatDate(f, I.formatDate)) && y.push("nue_disabled"),
                                            -1 !== I.disabledWeekDays.indexOf(a) && y.push("nue_disabled"),
                                            O.is("[disabled]") && y.push("nue_disabled"),
                                            i && "" !== i[1] && y.push(i[1]),
                                            W.currentTime.getMonth() !== M && y.push("nue_other_month"),
                                            (I.defaultSelect || _.data("changed")) && E.formatDate(W.currentTime, I.formatDate) === E.formatDate(f, I.formatDate) && y.push("nue_current"),
                                            E.formatDate(m, I.formatDate) === E.formatDate(f, I.formatDate) && y.push("nue_today"),
                                            (0 !== f.getDay() && 6 !== f.getDay() && -1 === I.weekends.indexOf(E.formatDate(f, I.formatDate))) || y.push("nue_weekend"),
                                            void 0 !== I.highlightedDates[E.formatDate(f, I.formatDate)] &&
                                                ((t = I.highlightedDates[E.formatDate(f, I.formatDate)]), y.push(void 0 === t.style ? "nue_highlighted_default" : t.style), (d = void 0 === t.desc ? "" : t.desc)),
                                            ...
                                            (l +=
                                                ...
                                                '" data-year="' +
                                                r +
                                                '" class="nue_date nue_day_of_week' +
                                                f.getDay() +
                                                " " +
                                                y.join(" ") +
                                                '" title="' +
                                    ...
                                    (l += "</tbody></table>"),
                                        C.html(l),
                                        F.find(".nue_label span").eq(0).text(I.i18n[R].months[W.currentTime.getMonth()]),
                                        F.find(".nue_label span")
                                            .eq(1)
                                    ...
                                    if (
                                        ((s = function (e, t) {
                                            ...
                                            var o = 60 * e + t;
                                            (O.is("[disabled]") || S <= o || o < x) && y.push("nue_disabled"),
                                                ...
                                                (I.initTime || I.defaultSelect || _.data("changed")) &&
                                                    ...
                                                    (I.defaultSelect || _.data("changed") ? y.push("nue_current") : I.initTime && y.push("nue_init_time")),
                                                parseInt(m.getHours(), 10) === parseInt(e, 10) && parseInt(m.getMinutes(), 10) === parseInt(t, 10) && y.push("nue_today"),
                                                (k += '<div class="nue_time ' + y.join(" ") + '" data-hour="' + e + '" data-minute="' + t + '">' + E.formatDate(n, I.formatTime) + "</div>");
                                        }),
                                    ...
                                    for (P.html(k), H = "", c = parseInt(I.yearStart, 10); c <= parseInt(I.yearEnd, 10); c += 1)
                                        H += '<div class="nue_option ' + (W.currentTime.getFullYear() === c ? "nue_current" : "") + '" data-value="' + c + '">' + (c + I.yearOffset) + "</div>";
                                    for (A.children().eq(0).html(H), c = parseInt(I.monthStart, 10), H = ""; c <= parseInt(I.monthEnd, 10); c += 1)
                                        H += '<div class="nue_option ' + (W.currentTime.getMonth() === c ? "nue_current" : "") + '" data-value="' + c + '">' + I.i18n[R].months[c] + "</div>";
                            ...
                            var e, t, a, n;
                            I.timepicker &&
                                (P.find(".nue_current").length ? (e = ".nue_current") : P.find(".nue_init_time").length && (e = ".nue_init_time"),
                                e
                                    ? ((t = u[0].clientHeight), (a = P[0].offsetHeight) - t < (n = P.find(e).index() * I.timeHeightInTimePicker + 1) && (n = a - t), u.trigger("scroll_element.nue_scroller", [parseInt(n, 10) / (a - t)]))
                                    : u.trigger("scroll_element.nue_scroller", [0]));
                        }),
                        (n = 0),
                        C.on("touchend click.xdsoft", "td", function (e) {
                            ...
                            var t = L(this),
                                a = W.currentTime;
                            if ((null == a && ((W.currentTime = W.now()), (a = W.currentTime)), t.hasClass("nue_disabled"))) return !1;
                            a.setDate(1),
                        ...
                        O.on("mousewheel.xdsoft", function (e) {
                            return (
                                ...
                                (!I.datepicker && I.timepicker
                                    ? (0 <= (a = P.find(".nue_current").length ? P.find(".nue_current").eq(0).index() : 0) + e.deltaY && a + e.deltaY < P.children().length && (a += e.deltaY),
                        ...
                        _.on("open.xdsoft", function (e) {
                            ...
                            .on("close.xdsoft", function (e) {
                                var t = !0;
                                F.find(".nue_month,.nue_year").find(".nue_select").hide(),
                            ...
                            .data("input", O),
                        (d = 0),
                        _.data("nue_datetime", W),
                        _.setOptions(I),
                        W.setCurrentTime(f()),
                        O.data("nue_datetimepicker", _)
                            .on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function () {
                                O.is(":disabled") ||
                                    (O.data("nue_datetimepicker").is(":visible") && I.closeOnInputClick) ||
                                    (I.openOnFocus &&
                                        (clearTimeout(d),
                ...
                (r = function (e) {
                    var t = e.data("nue_datetimepicker");
                    t &&
                        (t.data("nue_datetime", null),
                        t.remove(),
                        e.data("nue_datetimepicker", null).off(".xdsoft"),
                ...
                this.each(function () {
                    var t,
                        e = L(this).data("nue_datetimepicker");
                    if (e) {
                        if ("string" === L.type(H))
                            switch (H) {
                                case "show":
                                ...
                                case "destroy":
                                    ...
                                    break;
                                case "reset":
                                    (this.value = this.defaultValue), (this.value && e.data("nue_datetime").isValidDate(E.parseDate(this.value, I.format))) || e.data("changed", !1), e.data("nue_datetime").setCurrentTime(this.value);
                                    break;
                                case "validate":
                    ...
                    "string" !== L.type(H) &&
                        (!I.lazyInit || I.open || I.inline
                            ...
                            : (t = L(this)).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function e() {
                                  t.is(":disabled") ||
                                      t.data("nue_datetimepicker") ||
                                      (clearTimeout(i),
                                      (i = setTimeout(function () {
                                          t.data("nue_datetimepicker") || n(t), t.off("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", e).trigger("open.xdsoft");
                                      }, 100)));
                              }));
                }),
                o
