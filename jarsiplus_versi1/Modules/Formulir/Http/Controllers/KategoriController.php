   ...
   protected $title = 'Kategori Urusan';
    ...
    public function datatable($data) 
    {
        ...
        ->editColumn('action', function($data) {
            ...
            </a>'.'<a href="'.route("$this->prefix.urusan.index", $data->uuid).'" class="link link-secondary">
            <span class="iconify" data-icon="uil:edit"></span> <span class="">urusan</span>
            </a>';
