<div class="card-body bg-light pb-10" style="min-height:calc(100vh - 163px)">
    <div class="row mb-3">
        <label class="col-sm-2 col-form-label" for="label">
            Bantuan Pertanyaan <span class="text-danger">*</span>
        </label>
        <div class="col-sm-9">
        ...
        <div class="row mb-3">
        <label class="col-sm-2 col-form-label" for="jawaban">
            Jawaban <span class="text-danger">*</span>
        </label>
        <div class="col-sm-9">
            {!! Form::textarea('jawaban', null, ['class' => 'tinymce']) !!}
            {!! $errors->first('jawaban', ' <span class="invalid-feedback">:message</span>') !!}
        </div>
    </div>
</div>
