...
{!! Form::open(['route' => ["epanel.permohonan.file.store", $kategori->uuid], 'autocomplete' => 'off', 'files' => true]) !!}
                ...
                <div class="card-body">
                    <div class="card card-bordered shadow-none rounded-0">
                      ...
                      <section class="py-5" style="padding-left: 5vh;">
                        ...
                        <h5 class="fw-bold">DISETUJUI OLEH {{$data->count()}} Pembahas DARI {{ $tksd }} Pembahas</h5>
                </section>
                <!-- Section: Timeline -->
            </div>
        </div>
