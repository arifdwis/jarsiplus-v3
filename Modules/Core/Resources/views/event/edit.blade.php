...
{!! Form::model($edit, ['route' => ["$prefix.update", $edit->uuid ?? $edit->id], 'autocomplete' => 'off', 'files' => true, 'method' => 'PUT']) !!}
<div class="card rounded-0 shadow-0 border-top-0">
    <div class="card-header rounded-0 bg-white p-2">
        ...
        <p class="mb-0">Just complete these forms to update your data.</p>
    </div>
    @include("$view.form")
</div>
{!! Form::close() !!}
