...
<!-- BAIMBAI LOMBA BANNER -->
<div class="section pb-3">
    <div class="mb-3">
        <img src="{{ asset('baimbai/Banner Lomba Baimbai 2026.jpeg') }}" class="img-fluid rounded shadow-sm"
            alt="Banner Lomba Baimbai 2026" style="width: 100%;">
    </div>

    <div class="row">
        <div class="col-6">
            <a href="{{ asset('baimbai/Edaran Lomba Inovasi 2026 TTE.pdf') }}" target="_blank"
                class="btn btn-primary btn-block d-flex justify-content-center align-items-center"
                style="border-radius: 10px; padding: 10px;">
                <ion-icon name="document-text-outline" class="mr-1"></ion-icon> Surat Edaran
            </a>
        </div>
        <div class="col-6">
    <a href="{{ asset('baimbai/PANDUAN LOMBA INOVASI 2026.pdf') }}"
        class="btn btn-primary btn-block d-flex justify-content-center align-items-center"
        style="border-radius: 10px; padding: 10px;">
        <ion-icon name="download-outline" class="mr-1"></ion-icon> Panduan Lomba
    </a>
</div>
    </div>
</div>
<!-- END BAIMBAI LOMBA BANNER -->
            ...
            <a href="{{route('permohonan.create')}}">
                <div class="card bg-primary h-100">
                    <svg class="card-img-top mt-2 px-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <path fill="#CCCC31"
                            d="M14.217 3.5a5.17 5.17 0 0 0-4.434 0L5.489 5.512a2.25 2.25 0 0 1 .647 4.306l-1.076.461c-.534.23-.837.362-1.042.467a4.315 4.315 0 0 0-.003.05L9.783 13.5a5.17 5.17 0 0 0 4.434 0l6.691-3.137c1.456-.682 1.456-3.044 0-3.726L14.217 3.5Z" />

                        <path fill="#CCCC31"
                            d="M5.545 8.44a.75.75 0 0 0-.59-1.38l-1.112.477c-.557.239-1.03.441-1.4.65c-.395.222-.734.482-.989.868c-.254.386-.36.8-.408 1.25C1 10.729 1 11.242 1 11.85v2.901a.75.75 0 0 0 1.5 0v-2.862c0-.656.001-1.088.037-1.421c.034-.315.093-.47.17-.586c.075-.115.195-.231.471-.387c.292-.164.689-.335 1.292-.593l1.075-.461Z" />
            ...
            <a href="{{route('statistik.index')}}">
                <div class="card bg-primary h-100">
                    <svg class="card-img-top mt-2 px-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <g>
                            <path fill="#fff"
                                d="M6.222 4.601a9.499 9.499 0 0 1 1.395-.771c1.372-.615 2.058-.922 2.97-.33c.913.59.913 1.56.913 3.5v1.5c0 1.886 0 2.828.586 3.414c.586.586 1.528.586 3.414.586H17c1.94 0 2.91 0 3.5.912c.592.913.285 1.599-.33 2.97a9.498 9.498 0 0 1-10.523 5.435A9.5 9.5 0 0 1 6.222 4.601Z"
                                opacity="1" />
                            <path fill="#CCCC31"
                ...
                <div class="card bg-primary h-100">
                    <svg class="card-img-top mt-2 px-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <g fill="currentColor">
                            ...
                            <path fill="#CCCC31"
                                d="M6.25 10.5A.75.75 0 0 1 7 9.75h10a.75.75 0 0 1 0 1.5H7a.75.75 0 0 1-.75-.75Zm1 3.5a.75.75 0 0 1 .75-.75h8a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1-.75-.75Zm1 3.5a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 0 1.5H9a.75.75 0 0 1-.75-.75Z"
                                clip-rule="evenodd" />
                        </g>
                    </svg>
                    <div class="card-body text-uppercase text-center pt-2">
