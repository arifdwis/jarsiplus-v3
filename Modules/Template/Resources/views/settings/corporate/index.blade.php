...
<section class="page-header">
    <div class="header-light text-center mb-3">
        <h1 class="title">Satuan Kerja</h1>
        <h4 class="subtitle">Kelola satuan kerja anda pada halaman berikut.</h4>
    </div>
</section>
...
<div class="section pb-1 pt-4">
    {!! Form::model($data, ['route' => ["$prefix.update", $data->uuid], 'autocomplete' => 'off', 'method' => 'PUT','required']) !!}
    @include("$view.form")
