...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-3 px-1">
                    <div class="legenda bg-primary" data-title="Persetujuan"
                        data-description="Pemohon diharuskan untuk mengisi indikator dan parameter yang diperlukan ">
    ...
    <div class="section mt-3 mb-3">
        <div class="row">
            ...
            @php
                use Carbon\Carbon;
                $is_closed = Carbon::now('Asia/Makassar')->lessThan(Carbon::create(2026, 4, 1, 0, 0, 0, 'Asia/Makassar'));
                ...
                @else
                    <div class="card h-100 permohonan-closed" style="cursor: not-allowed; opacity: 0.6;">
                        <div class="card-body text-center card-create pt-2">
                            <ion-icon name="create-outline"></ion-icon>
                            <h1 class="text-muted">New Permohonan</h1>
                            <small class="text-danger">Input Ditutup</small>
                        </div>
                    </div>
                @endif
            </div>
            ...
            @if($data)
                ...
                @foreach($data as $value)
                    <div class="col-6 col-lg-3 mb-2">
                        <a href="{{route('beimbai.show', $value->kode)}}">
                            <div class="card  h-100">
