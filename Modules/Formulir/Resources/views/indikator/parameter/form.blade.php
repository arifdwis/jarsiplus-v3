<div class="card-body bg-light pb-10" style="min-height:calc(100vh - 163px)">
    ...
    <div class="row mb-3">
        <label class="col-sm-2 col-form-label" for="bobot">
            Bobot <span class="text-danger">*</span>
        </label>
        <div class="col-sm-9">
            {!! Form::number('bobot', null, ['class' => 'form-control' . $errors->first('bobot', ' is-invalid')]) !!}
            {!! $errors->first('bobot', ' <span class="invalid-feedback">:message</span>') !!}
        </div>
    </div>
    <div class="row mb-3">
        ...
        <div class="col-sm-9">
            {!! Form::textarea('deskripsi', null, ['class' => 'form-control' . $errors->first('deskripsi', ' is-invalid')]) !!}
